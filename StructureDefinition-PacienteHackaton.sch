...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      <sch:assert test="count(f:extension[@url = 'https://hlf.cl/fhir/ig/hackaton/StructureDefinition/SexoNacimiento820']) &gt;= 1">extension with URL = 'https://hlf.cl/fhir/ig/hackaton/StructureDefinition/SexoNacimiento820': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://hlf.cl/fhir/ig/hackaton/StructureDefinition/SexoNacimiento820']) &lt;= 1">extension with URL = 'https://hlf.cl/fhir/ig/hackaton/StructureDefinition/SexoNacimiento820': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://hlf.cl/fhir/ig/hackaton/StructureDefinition/IdentidadGenero']) &lt;= 1">extension with URL = 'https://hlf.cl/fhir/ig/hackaton/StructureDefinition/IdentidadGenero': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:name">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://hlf.cl/fhir/ig/hackaton/StructureDefinition/NombreSocial']) &lt;= 1">extension with URL = 'https://hlf.cl/fhir/ig/hackaton/StructureDefinition/NombreSocial': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://hlf.cl/fhir/ig/hackaton/StructureDefinition/SegundoApellido']) &lt;= 1">extension with URL = 'https://hlf.cl/fhir/ig/hackaton/StructureDefinition/SegundoApellido': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:use) &lt;= 1">use: maximum cardinality of 'use' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:address">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://hlf.cl/fhir/ig/hackaton/StructureDefinition/TipoVia']) &lt;= 1">extension with URL = 'https://hlf.cl/fhir/ig/hackaton/StructureDefinition/TipoVia': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:use) &lt;= 1">use: maximum cardinality of 'use' is 1</sch:assert>
      <sch:assert test="count(f:type) &lt;= 1">type: maximum cardinality of 'type' is 1</sch:assert>
      <sch:assert test="count(f:text) &lt;= 1">text: maximum cardinality of 'text' is 1</sch:assert>
